export const it = {
  ...
  hero: {
    subtitle: "SOLUZIONI DI CONSULENZA GOVERNATIVA",
    title: "Servizi di Consulenza Governativa Esperti",
    description: "Scopri le nostre soluzioni complete di consulenza governativa, che offrono orientamento strategico, sviluppo di politiche ed eccellenza operativa per le organizzazioni del settore pubblico.",
    bookStay: "Inizia Ora",
    exploreApartments: "I Nostri Servizi",
